...
*/  
    cout << "valor na variavel numero: " << numero
         ...
         << "\nvalor de um ponteiro vazio: " << ponteiroVazio
         << endl;
    dobra(ponteiro);
    cout << "funcao de dobrar o numero: " << numero << endl;
...
*/
    cout << "primeira casa do vetor: " << *(pVetor + 0)    
